...
export default class OParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterEmptyCategoryMethodList(ctx) {
	}
	...
	enterCurlyCategoryMethodList(ctx) {
	}
	...
	enterFiltered_list_expression(ctx) {
	}
