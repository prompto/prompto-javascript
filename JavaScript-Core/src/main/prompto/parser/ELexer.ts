// Generated from ELexer.g4 by ANTLR 4.11.2-SNAPSHOT

import { default as antlr4 } from 'antlr4';

export default class ELexer extends antlr4.Lexer {
	...
	constructor(input: antlr4.CharStream) {
		super(input);
		this._interp = new antlr4.atn.LexerATNSimulator(this, ELexer._ATN, ELexer.DecisionsToDFA, new antlr4.atn.PredictionContextCache());
	}
	...
	public static get _ATN(): antlr4.atn.ATN {
		if (!ELexer.__ATN) {
			ELexer.__ATN = new antlr4.atn.ATNDeserializer().deserialize(ELexer._serializedATN);
		}
	...
	static DecisionsToDFA = ELexer._ATN.decisionToState.map( (ds, index) => new antlr4.dfa.DFA(ds, index) );
}