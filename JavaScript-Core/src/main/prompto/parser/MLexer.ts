...
export default class MLexer extends antlr4.Lexer {
	...
	constructor(input: antlr4.CharStream) {
		super(input);
		this._interp = new antlr4.atn.LexerATNSimulator(this, MLexer._ATN, MLexer.DecisionsToDFA, new antlr4.atn.PredictionContextCache());
	}
	...
	public static get _ATN(): antlr4.atn.ATN {
		if (!MLexer.__ATN) {
			MLexer.__ATN = new antlr4.atn.ATNDeserializer().deserialize(MLexer._serializedATN);
		}
	...
	static DecisionsToDFA = MLexer._ATN.decisionToState.map( (ds, index) => new antlr4.dfa.DFA(ds, index) );
}