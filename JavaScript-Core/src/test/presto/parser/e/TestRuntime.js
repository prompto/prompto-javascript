...
exports.testSystemOutPrint = function(test) {
	var parser = new presto.parser.ECleverParser("process.stdout.write(value);");
	...
	context.setValue("value", new presto.literal.TextLiteral("\"test\"")); // TextLiteral trims enclosing quotes
