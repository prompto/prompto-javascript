...
var presto = require("../../../../main/presto/index"); // presto

function OTestParser(code) {
	presto.parser.OCleverParser.call(this, code);
	return this;
}

OTestParser.prototype = Object.create(presto.parser.OCleverParser.prototype);
OTestParser.prototype.constructor = OTestParser;

OTestParser.prototype.value = function (tree) {
	var builder = new presto.parser.OPrestoBuilder(this);
...
exports.testMemberExpression = function(test) {
	...
	test.ok(e instanceof presto.expression.MemberSelector);
	test.equal("name",e.name);
	test.ok(e.parent instanceof presto.expression.InstanceExpression);
...
exports.testMethodCallWith = function(test) {
	...
	test.ok(exp instanceof presto.expression.AddExpression);
    writer = new presto.utils.CodeWriter(presto.parser.Dialect.O)
    mc.toDialect(writer);
...
exports.testMethod1Parameter1Statement = function(test) {
	...
	test.ok(ad.args);
	var arg = new presto.grammar.CategoryArgument(new presto.type.CategoryType("Person"),"p",null);
...
exports.testMethod1Extended1Statement = function(test) {
	...
	test.equal("printName",ad.name);
	test.ok(ad.args);
	var type = new presto.type.CategoryType("Object")
	var idlist = new presto.grammar.IdentifierList("name");
	var expected = new presto.grammar.CategoryArgument(type, "o", idlist);
...
exports.testMethod1Array1Statement = function(test) {
	...
	test.equal("printName",ad.name);
	test.ok(ad.args);
	var type = new presto.type.ListType(new presto.type.CategoryType("Option"))
	var expected = new presto.grammar.CategoryArgument(type,"options",null);
	test.ok(ad.args[0].equals(expected));
	test.ok(ad.statements);
    writer = new presto.utils.CodeWriter(presto.parser.Dialect.O)
    ad.statements[0].toDialect(writer);
...
exports.testConstructor2AttributesComma = function(test) {
	...
	var e = a.expression;
	test.ok(e);
	test.ok(e instanceof presto.literal.IntegerLiteral);
	a = as[1];
	test.ok(a);
	test.equal("name",a.name);
	e = a.expression;
	test.ok(e);
	test.ok(e instanceof presto.literal.TextLiteral);
	test.done();
};
...
exports.testNativeJava = function(test) {
	...
	test.ok(call);
	test.ok(call instanceof presto.statement.NativeCall);
	test.done();
};
...
exports.testNativeMethod = function(test) {
	...
	test.ok(method);
	test.ok(method instanceof presto.declaration.NativeMethodDeclaration);
	test.done();
};
...
exports.testBooleanLiteral = function(test) {
	...
	test.ok(literal);
	test.ok(literal instanceof presto.literal.BooleanLiteral);
...
exports.testTextLiteral = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.TextLiteral);
...
exports.testIntegerLiteral = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.IntegerLiteral);
...
exports.testParseHexa = function(test) {
	test.equal(0x0A11, presto.literal.HexaLiteral.parseHexa("0x0A11").IntegerValue());
	test.done();
};
...
exports.testHexaLiteral = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.HexaLiteral);
...
exports.testDecimalLiteral = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.DecimalLiteral);
...
exports.testEmptyListLiteral = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.ListLiteral);
...
exports.testSimpleListLiteral = function(test) {
	...
	test.ok(literal instanceof presto.literal.ListLiteral);
	test.ok(literal.expressions[0] instanceof presto.expression.InstanceExpression);
	test.ok(literal.expressions[1] instanceof presto.literal.IntegerLiteral);
	test.done();
};
...
exports.testEmptyDictLiteral = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.DictLiteral);
	test.equal("{}", literal.toString());
	test.done();
};
...
exports.testSimpleDate = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.DateLiteral);
...
exports.testSimpleTime = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.TimeLiteral);
...
exports.testDateTime = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.DateTimeLiteral);
...
exports.testPeriod = function(test) {
	...
	var literal = parser.parse_literal_expression();
	test.ok(literal);
	test.ok(literal instanceof presto.literal.PeriodLiteral);
...
exports.testNativeSymbol = function(test) {
	...
	test.ok(symbol);
	test.ok(symbol instanceof presto.grammar.NativeSymbol);
    writer = new presto.utils.CodeWriter(presto.parser.Dialect.O)
...
exports.testInstanceExpression = function(test) {
	...
	test.ok(exp instanceof presto.expression.InstanceExpression);
	test.done();
}; 
