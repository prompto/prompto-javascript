...
exports.testDateTimeDayOfYear = function(test) {
	compareResourceEOE(test, "builtins/dateTimeDayOfYear.pec");
};
...
exports.testDateTimeMonth = function(test) {
	compareResourceEOE(test, "builtins/dateTimeMonth.pec");
};
...
exports.testDateTimeYear = function(test) {
	compareResourceEOE(test, "builtins/dateTimeYear.pec");
};
...
exports.testEnumSymbols = function(test) {
	compareResourceEOE(test, "builtins/enumSymbols.pec");
};
...
exports.testIntegerFormat = function(test) {
	compareResourceEOE(test, "builtins/integerFormat.pec");
};
...
exports.testTextEndsWith = function(test) {
	compareResourceEOE(test, "builtins/textEndsWith.pec");
};
...
exports.testTextReplace = function(test) {
	compareResourceEOE(test, "builtins/textReplace.pec");
};

exports.testTextReplaceAll = function(test) {
	compareResourceEOE(test, "builtins/textReplaceAll.pec");
};
...
exports.testTextStartsWith = function(test) {
	compareResourceEOE(test, "builtins/textStartsWith.pec");
};
...
exports.testTextTrim = function(test) {
	compareResourceEOE(test, "builtins/textTrim.pec");
};
...
exports.testTimeMinute = function(test) {
	compareResourceEOE(test, "builtins/timeMinute.pec");
};
