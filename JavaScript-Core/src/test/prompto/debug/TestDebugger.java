...
import prompto.parser.boa.BaseBoaParserTest;
...
public class TestDebugger extends BaseBoaParserTest {
	...
	public void testStackNoDebug() throws Exception {
		runResource("debug/stack.boa");
		assertEquals("test123-ok", Out.read());
	}

	@Test
	public void testResume() throws Exception {
		debugResource("debug/stack.boa");
		thread.start();
		waitBlocked();
