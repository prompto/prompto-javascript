...
export default class OParser extends AbstractParser {
    ...
    static readonly RULE_category_symbol = 2;
    static readonly RULE_native_symbol = 3;
    ...
    static readonly RULE_category_method_list = 10;
    ...
    static readonly RULE_native_category_declaration = 17;
    ...
    static readonly RULE_statement_or_list = 27;
    static readonly RULE_statement = 28;
    static readonly RULE_flush_statement = 29;
    static readonly RULE_store_statement = 30;
    static readonly RULE_with_resource_statement = 31;
    static readonly RULE_with_singleton_statement = 32;
    static readonly RULE_switch_statement = 33;
    static readonly RULE_switch_case_statement = 34;
    static readonly RULE_for_each_statement = 35;
    static readonly RULE_do_while_statement = 36;
    static readonly RULE_while_statement = 37;
    static readonly RULE_if_statement = 38;
    static readonly RULE_else_if_statement_list = 39;
    static readonly RULE_raise_statement = 40;
    static readonly RULE_try_statement = 41;
    static readonly RULE_catch_statement = 42;
    static readonly RULE_break_statement = 43;
    static readonly RULE_return_statement = 44;
    static readonly RULE_method_call_expression = 45;
    static readonly RULE_method_call_statement = 46;
    static readonly RULE_x_expression = 47;
    static readonly RULE_expression = 48;
    static readonly RULE_filter_expression = 49;
    static readonly RULE_an_expression = 50;
    static readonly RULE_type_expression = 51;
    static readonly RULE_selectable_expression = 52;
    static readonly RULE_instance_expression = 53;
    static readonly RULE_mutable_instance_expression = 54;
    static readonly RULE_method_expression = 55;
    static readonly RULE_blob_expression = 56;
    static readonly RULE_document_expression = 57;
    static readonly RULE_write_statement = 58;
    static readonly RULE_filtered_list_expression = 59;
    static readonly RULE_fetch_expression = 60;
    static readonly RULE_fetch_statement = 61;
    static readonly RULE_then = 62;
    static readonly RULE_read_statement = 63;
    static readonly RULE_sorted_expression = 64;
    static readonly RULE_instance_selector = 65;
    static readonly RULE_constructor_expression = 66;
    static readonly RULE_copy_from = 67;
    static readonly RULE_argument_assignment_list = 68;
    static readonly RULE_argument_assignment = 69;
    static readonly RULE_assign_instance_statement = 70;
    static readonly RULE_child_instance = 71;
    static readonly RULE_assign_tuple_statement = 72;
    static readonly RULE_type_literal = 73;
    static readonly RULE_null_literal = 74;
    static readonly RULE_ws_plus = 75;
    static readonly RULE_repl = 76;
    static readonly RULE_declaration_list = 77;
    static readonly RULE_declarations = 78;
    static readonly RULE_declaration = 79;
    static readonly RULE_annotation_constructor = 80;
    static readonly RULE_annotation_identifier = 81;
    static readonly RULE_annotation_argument = 82;
    static readonly RULE_annotation_argument_name = 83;
    static readonly RULE_annotation_argument_value = 84;
    static readonly RULE_resource_declaration = 85;
    static readonly RULE_enum_declaration = 86;
    static readonly RULE_native_symbol_list = 87;
    static readonly RULE_category_symbol_list = 88;
    static readonly RULE_symbol_list = 89;
    static readonly RULE_attribute_constraint = 90;
    static readonly RULE_list_literal = 91;
    static readonly RULE_set_literal = 92;
    static readonly RULE_expression_list = 93;
    static readonly RULE_range_literal = 94;
    static readonly RULE_typedef = 95;
    static readonly RULE_primary_type = 96;
    static readonly RULE_native_type = 97;
    static readonly RULE_category_type = 98;
    static readonly RULE_mutable_category_type = 99;
    static readonly RULE_code_type = 100;
    static readonly RULE_category_declaration = 101;
    static readonly RULE_widget_declaration = 102;
    static readonly RULE_type_identifier_list = 103;
    static readonly RULE_method_identifier = 104;
    static readonly RULE_identifier_or_keyword = 105;
    static readonly RULE_nospace_hyphen_identifier_or_keyword = 106;
    static readonly RULE_nospace_identifier_or_keyword = 107;
    static readonly RULE_identifier = 108;
    static readonly RULE_member_identifier = 109;
    static readonly RULE_variable_identifier = 110;
    static readonly RULE_attribute_identifier = 111;
    static readonly RULE_type_identifier = 112;
    static readonly RULE_symbol_identifier = 113;
    static readonly RULE_argument_list = 114;
    static readonly RULE_argument = 115;
    static readonly RULE_operator_argument = 116;
    static readonly RULE_named_argument = 117;
    static readonly RULE_code_argument = 118;
    static readonly RULE_category_or_any_type = 119;
    static readonly RULE_any_type = 120;
    static readonly RULE_member_method_declaration_list = 121;
    static readonly RULE_member_method_declaration = 122;
    static readonly RULE_native_member_method_declaration_list = 123;
    static readonly RULE_native_member_method_declaration = 124;
    static readonly RULE_native_category_binding = 125;
    static readonly RULE_python_category_binding = 126;
    static readonly RULE_python_module = 127;
    static readonly RULE_javascript_category_binding = 128;
    static readonly RULE_javascript_module = 129;
    static readonly RULE_variable_identifier_list = 130;
    static readonly RULE_attribute_identifier_list = 131;
    static readonly RULE_method_declaration = 132;
    static readonly RULE_comment_statement = 133;
    static readonly RULE_native_statement_list = 134;
    static readonly RULE_native_statement = 135;
    static readonly RULE_python_native_statement = 136;
    static readonly RULE_javascript_native_statement = 137;
    static readonly RULE_statement_list = 138;
    static readonly RULE_assertion_list = 139;
    static readonly RULE_switch_case_statement_list = 140;
    static readonly RULE_catch_statement_list = 141;
    static readonly RULE_literal_collection = 142;
    static readonly RULE_atomic_literal = 143;
    static readonly RULE_literal_list_literal = 144;
    static readonly RULE_this_expression = 145;
    static readonly RULE_super_expression = 146;
    static readonly RULE_parenthesis_expression = 147;
    static readonly RULE_literal_expression = 148;
    static readonly RULE_collection_literal = 149;
    static readonly RULE_tuple_literal = 150;
    static readonly RULE_dict_literal = 151;
    static readonly RULE_document_literal = 152;
    static readonly RULE_expression_tuple = 153;
    static readonly RULE_doc_entry_list = 154;
    static readonly RULE_doc_entry = 155;
    static readonly RULE_doc_key = 156;
    static readonly RULE_dict_entry_list = 157;
    static readonly RULE_dict_entry = 158;
    static readonly RULE_dict_key = 159;
    static readonly RULE_slice_arguments = 160;
    static readonly RULE_assign_variable_statement = 161;
    static readonly RULE_assignable_instance = 162;
    static readonly RULE_is_expression = 163;
    static readonly RULE_metadata = 164;
    static readonly RULE_arrow_expression = 165;
    static readonly RULE_arrow_prefix = 166;
    static readonly RULE_arrow_args = 167;
    static readonly RULE_sorted_key = 168;
    static readonly RULE_read_blob_expression = 169;
    static readonly RULE_read_all_expression = 170;
    static readonly RULE_read_one_expression = 171;
    static readonly RULE_order_by_list = 172;
    static readonly RULE_order_by = 173;
    static readonly RULE_include_list = 174;
    static readonly RULE_operator = 175;
    static readonly RULE_keyword = 176;
    static readonly RULE_new_token = 177;
    static readonly RULE_key_token = 178;
    static readonly RULE_module_token = 179;
    static readonly RULE_value_token = 180;
    static readonly RULE_symbols_token = 181;
    static readonly RULE_assign = 182;
    static readonly RULE_multiply = 183;
    static readonly RULE_divide = 184;
    static readonly RULE_idivide = 185;
    static readonly RULE_modulo = 186;
    static readonly RULE_lfs = 187;
    static readonly RULE_lfp = 188;
    static readonly RULE_javascript_statement = 189;
    static readonly RULE_javascript_expression = 190;
    static readonly RULE_javascript_primary_expression = 191;
    static readonly RULE_javascript_this_expression = 192;
    static readonly RULE_javascript_new_expression = 193;
    static readonly RULE_javascript_selector_expression = 194;
    static readonly RULE_javascript_method_expression = 195;
    static readonly RULE_javascript_arguments = 196;
    static readonly RULE_javascript_item_expression = 197;
    static readonly RULE_javascript_parenthesis_expression = 198;
    static readonly RULE_javascript_identifier_expression = 199;
    static readonly RULE_javascript_literal_expression = 200;
    static readonly RULE_javascript_identifier = 201;
    static readonly RULE_python_statement = 202;
    static readonly RULE_python_expression = 203;
    static readonly RULE_python_primary_expression = 204;
    static readonly RULE_python_self_expression = 205;
    static readonly RULE_python_selector_expression = 206;
    static readonly RULE_python_method_expression = 207;
    static readonly RULE_python_argument_list = 208;
    static readonly RULE_python_ordinal_argument_list = 209;
    static readonly RULE_python_named_argument_list = 210;
    static readonly RULE_python_parenthesis_expression = 211;
    static readonly RULE_python_identifier_expression = 212;
    static readonly RULE_python_literal_expression = 213;
    static readonly RULE_python_identifier = 214;
    static readonly RULE_java_statement = 215;
    static readonly RULE_java_expression = 216;
    static readonly RULE_java_primary_expression = 217;
    static readonly RULE_java_this_expression = 218;
    static readonly RULE_java_new_expression = 219;
    static readonly RULE_java_selector_expression = 220;
    static readonly RULE_java_method_expression = 221;
    static readonly RULE_java_arguments = 222;
    static readonly RULE_java_item_expression = 223;
    static readonly RULE_java_parenthesis_expression = 224;
    static readonly RULE_java_identifier_expression = 225;
    static readonly RULE_java_class_identifier_expression = 226;
    static readonly RULE_java_literal_expression = 227;
    static readonly RULE_java_identifier = 228;
    static readonly RULE_csharp_statement = 229;
    static readonly RULE_csharp_expression = 230;
    static readonly RULE_csharp_primary_expression = 231;
    static readonly RULE_csharp_this_expression = 232;
    static readonly RULE_csharp_new_expression = 233;
    static readonly RULE_csharp_selector_expression = 234;
    static readonly RULE_csharp_method_expression = 235;
    static readonly RULE_csharp_arguments = 236;
    static readonly RULE_csharp_item_expression = 237;
    static readonly RULE_csharp_parenthesis_expression = 238;
    static readonly RULE_csharp_identifier_expression = 239;
    static readonly RULE_csharp_literal_expression = 240;
    static readonly RULE_csharp_identifier = 241;
    static readonly RULE_jsx_expression = 242;
    static readonly RULE_jsx_element = 243;
    static readonly RULE_jsx_fragment = 244;
    static readonly RULE_jsx_fragment_start = 245;
    static readonly RULE_jsx_fragment_end = 246;
    static readonly RULE_jsx_self_closing = 247;
    static readonly RULE_jsx_opening = 248;
    static readonly RULE_jsx_closing = 249;
    static readonly RULE_jsx_element_name = 250;
    static readonly RULE_jsx_identifier = 251;
    static readonly RULE_jsx_attribute = 252;
    static readonly RULE_jsx_attribute_value = 253;
    static readonly RULE_jsx_children = 254;
    static readonly RULE_jsx_child = 255;
    static readonly RULE_jsx_text = 256;
    static readonly RULE_jsx_char = 257;
    static readonly RULE_css_expression = 258;
    static readonly RULE_css_field = 259;
    static readonly RULE_css_identifier = 260;
    static readonly RULE_css_value = 261;
    static readonly RULE_css_text = 262;
    ...
    derived_list(_p: number): Derived_listContext;
    category_method_list(): Category_method_listContext;
    ...
    statement_or_list(): Statement_or_listContext;
    ...
    x_expression(): X_expressionContext;
    expression(): ExpressionContext;
    expression(_p: number): ExpressionContext;
    filter_expression(): Filter_expressionContext;
    an_expression(): An_expressionContext;
    ...
    filtered_list_expression(): Filtered_list_expressionContext;
...
export declare class Enum_category_declarationContext extends ParserRuleContext {
    ...
    enterRule(listener: OParserListener): void;
    exitRule(listener: OParserListener): void;
}
...
export declare class Concrete_widget_declarationContext extends ParserRuleContext {
    _name: Type_identifierContext;
    _derived: Type_identifierContext;
    _methods: Category_method_listContext;
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
    WIDGET(): TerminalNode;
    type_identifier_list(): Type_identifierContext[];
    type_identifier(i: number): Type_identifierContext;
...
export declare class Category_method_listContext extends ParserRuleContext {
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
    get ruleIndex(): number;
    copyFrom(ctx: Category_method_listContext): void;
}
export declare class EmptyCategoryMethodListContext extends Category_method_listContext {
    constructor(parser: OParser, ctx: Category_method_listContext);
    SEMI(): TerminalNode;
    enterRule(listener: OParserListener): void;
    exitRule(listener: OParserListener): void;
}
export declare class CurlyCategoryMethodListContext extends Category_method_listContext {
    _items: Member_method_declaration_listContext;
    constructor(parser: OParser, ctx: Category_method_listContext);
    LCURL(): TerminalNode;
    RCURL(): TerminalNode;
    member_method_declaration_list(): Member_method_declaration_listContext;
...
export declare class Statement_or_listContext extends ParserRuleContext {
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
    get ruleIndex(): number;
    copyFrom(ctx: Statement_or_listContext): void;
}
export declare class CurlyStatementListContext extends Statement_or_listContext {
    _items: Statement_listContext;
...
export declare class SingleStatementContext extends Statement_or_listContext {
    _stmt: StatementContext;
    constructor(parser: OParser, ctx: Statement_or_listContext);
    statement(): StatementContext;
    enterRule(listener: OParserListener): void;
    exitRule(listener: OParserListener): void;
...
export declare class With_resource_statementContext extends ParserRuleContext {
    ...
    _stmts: Statement_or_listContext;
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
    WITH(): TerminalNode;
    LPAR(): TerminalNode;
    RPAR(): TerminalNode;
...
export declare class If_statementContext extends ParserRuleContext {
    ...
    _elseStmts: Statement_or_listContext;
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
    IF(): TerminalNode;
    LPAR(): TerminalNode;
    RPAR(): TerminalNode;
    expression(): ExpressionContext;
    statement_or_list_list(): Statement_or_listContext[];
    statement_or_list(i: number): Statement_or_listContext;
    ELSE(): TerminalNode;
    else_if_statement_list(): Else_if_statement_listContext;
    get ruleIndex(): number;
    enterRule(listener: OParserListener): void;
...
export declare class X_expressionContext extends ParserRuleContext {
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
    css_expression(): Css_expressionContext;
    get ruleIndex(): number;
    enterRule(listener: OParserListener): void;
...
export declare class IsAnExpressionContext extends ExpressionContext {
    _left: ExpressionContext;
    _right: An_expressionContext;
    constructor(parser: OParser, ctx: ExpressionContext);
    IS(): TerminalNode;
    expression(): ExpressionContext;
    an_expression(): An_expressionContext;
...
export declare class An_expressionContext extends ParserRuleContext {
    _typ: Category_or_any_typeContext;
    constructor(parser?: OParser, parent?: ParserRuleContext, invokingState?: number);
...
export declare class Filtered_list_expressionContext extends ParserRuleContext {
    _source: ExpressionContext;
    _name: Variable_identifierContext;
